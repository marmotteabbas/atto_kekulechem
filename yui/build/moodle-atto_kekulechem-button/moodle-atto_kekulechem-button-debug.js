 ...
 */
/* global Y, M, KekuleMoodle, Kekule*/
...
KC.Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
	...
	initializer: function() {
		...
		this.addButton({
                ...
                if (typeof Kekule !== 'undefined') {
                    this.initialKekuleStuff();
                } else  {
                    //Do something if it didn't load
                }

	},initialKekuleStuff: function() {
		// add essential CSS
		...
		var form = editor.textarea.getDOMNode().form;
                ...
                if(typeof Kekule.X !== "undefined") {
                    ...
                    console.log("error loading button atto due to Kekule.X Failure");
                }
	...
	_execute: function()
	{
                if (typeof Kekule !== 'undefined') {
                    ...
                    alert("Erreur de chargement de la librairie Kekule.js");
                }
	},
	/*
	...
	*/
	...
	_createDialog: function()
	{
		...
		*/
		...
		var inserter = window.interpreter;
